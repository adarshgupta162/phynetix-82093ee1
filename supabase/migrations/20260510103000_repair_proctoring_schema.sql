-- Repair / harden live monitoring schema deployment.
-- Some environments reported PostgREST could not find proctoring_test_settings
-- after the initial rollout. This idempotent migration guarantees the tables
-- exist, adds a compatibility alias for the common "protecting" typo, and
